...
const sampleWorkflowData = {
  nodes: [
    // Documents - Niveau 1 (Haut)
    { id: 'doc1', type: 'documentNode', data: { label: 'Manuel de maintenance', category: 'Technical', status: 'approved' }, position: { x: 400, y: 50 } },
    { id: 'doc2', type: 'documentNode', data: { label: 'Procédure d\'inspection', category: 'Procedure', status: 'pending' }, position: { x: 150, y: 150 } },
    { id: 'doc3', type: 'documentNode', data: { label: 'Certificat de conformité', category: 'Certification', status: 'approved' }, position: { x: 650, y: 150 } },
    
    // Étapes de livraison - Niveau 2
    { id: 'delivery1', type: 'deliveryNode', data: { label: 'Livraison initiale', date: '2025-04-10', responsible: 'Jean Dupont' }, position: { x: 400, y: 250 } },
    { id: 'delivery2', type: 'deliveryNode', data: { label: 'Mise à jour documentation', date: '2025-04-25', responsible: 'Marie Laurent' }, position: { x: 150, y: 350 } },
    
    // Étapes de validation - Niveau 3
    { id: 'validation1', type: 'validationNode', data: { label: 'Validation technique', status: 'completed', validator: 'Pierre Martin' }, position: { x: 650, y: 350 } },
    { id: 'validation2', type: 'validationNode', data: { label: 'Approbation finale', status: 'pending', validator: 'Sophie Bernard' }, position: { x: 400, y: 450 } },
    
    // Pièces - Niveau 4 (Bas)
    { id: 'part1', type: 'partNode', data: { label: 'Moteur CFM56', partNumber: 'CFM56-5B', serialNumber: 'SN12345' }, position: { x: 150, y: 550 } },
    { id: 'part2', type: 'partNode', data: { label: 'Train d\'atterrissage', partNumber: 'LG-A320-001', serialNumber: 'SN54321' }, position: { x: 650, y: 550 } }
  ],
  edges: [
    ...
    { id: 'e2-5', source: 'doc2', target: 'delivery2', animated: true, label: 'Livré le 25/04/2025', type: 'smoothstep' },
    ...
    { id: 'e4-6', source: 'delivery1', target: 'validation1', animated: true, label: 'Pour validation', type: 'smoothstep' },
    { id: 'e5-7', source: 'delivery2', target: 'validation2', animated: true, label: 'Pour approbation', type: 'smoothstep' },
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={9}>
          <Paper sx={{ p: 1, height: 700, position: 'relative' }}>
            ...
            {loading ? (
              ...
              <WorkflowGraph data={workflowData} zoom={zoom} filter={filterCategory} search={searchTerm} />
            )}
          </Paper>
        </Grid>
